...
<body>
          ...
          <div class="ml-auto lang-dropdown">
            <button class="lang-btn" id="langBtn">
              <div class="flex items-center text-[14px] lanBtnVal">
                <div id="lanBtnVal">{{ strtoupper( session('locale', 'ru')) }}</div>
            ...
            <div class="lang-menu" id="langMenu">
              <a href="{{ route('set.lang', 'uz') }}">UZ</a>
              <a href="{{ route('set.lang', 'en') }}">EN</a>
              <a href="{{ route('set.lang', 'ru') }}">RU</a>
            </div>
          </div>
        </nav>
  ...
  <main>
    ...
    <footer
      ...
      <div
        class="absolute w-full h-[1px] bg-white opacity-20 bottom-[100px] sm:bottom-[68px]"></div>
    </footer>
  </main>
  <!-- fancybox -->
