...
@endphp
  @section('content')
          ...
          <!-- 1-section -->
       <x-hero :title="__('app.portfolio')"  :breadcrumbs="[__('app.home') => url('/'), __('app.portfolio') => url('/portfolio')]" />
      ...
      <section class="py-6 sm:py-10 lg:pt-[95px] lg:pb-[100px]">
        <div class="container">
          ...
          <a
              href="{{ route('portfolioIn.page', $portfolio -> slug)  }}"
              style="
                background: url({{ asset('storage/' . $portfolio -> bgImage) }}) no-repeat center / cover;
              "
            ...
            >
              ...
              <div class="z-1">
                ...
                >
                  {!! Str::limit($portfolio->{'text_' . $locale}, 150) !!}
                </p>
                <div
