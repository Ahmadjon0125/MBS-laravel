@extends('layouts.app')
  ...
  @section('content')
      ...
      <!-- 1-section -->
       <x-hero :title="'Ut enim ad minim veniam'"  :breadcrumbs="['Главная' => url('/'), 'Портфолио' => url('/news'), 'Ut enim ad minim veniam' => url('/')]" />
              ...
              <div class="swiper main-slider">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="./img/portIn1.jpg" />
                  </div>
                  <div class="swiper-slide">
                    <img src="./img/portIn2.jpg" />
                  </div>
                  <div class="swiper-slide">
                    <img src="./img/portIn3.jpg" />
                  </div>
                  <div class="swiper-slide">
                    <img src="./img/portIn4.jpg" />
                  </div>
                  <div class="swiper-slide">
                    <img src="./img/portIn5.jpg" />
                  </div>
                  <div class="swiper-slide">
                    <img src="./img/portIn6.jpg" />
                  </div>
                  <div class="swiper-slide">
                    <img src="./img/portIn1.jpg" />
                  </div>
